...
rp_module_licence="NONCOM https://raw.githubusercontent.com/EmulOS/snes9x-rpi/master/snes9x.h"
...
function sources_snes9x() {
    gitPullOrClone "$md_build" https://github.com/EmulOS/snes9x-rpi.git retropie
}
