...
rp_module_licence="NONCOM https://raw.githubusercontent.com/EmulOS/mame4all-pi/master/readme.txt"
rp_module_repo="git https://github.com/EmulOS/mame4all-pi.git master"
