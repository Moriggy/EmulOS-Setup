...
rp_module_help="Necesitas copiar las BIOS de X68000 (iplrom30.dat, iplromco.dat, iplrom.dat, o iplromxv.dat), y el archivo de fuente (cgrom.dat or cgrom.tmp) en $romdir/BIOS/keropi. Usa F12 para acceder al menú del emulador."
