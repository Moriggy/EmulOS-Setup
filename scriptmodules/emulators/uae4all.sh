...
rp_module_licence="GPL2 https://raw.githubusercontent.com/EmulOS/uae4all2/retropie/copying"
...
function sources_uae4all() {
    gitPullOrClone "$md_build" https://github.com/EmulOS/uae4all2.git retropie
    mkdir guichan
