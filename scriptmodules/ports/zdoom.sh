...
rp_module_licence="OTHER https://raw.githubusercontent.com/EmulOS/zdoom/master/docs/licenses/README.TXT"
...
function sources_zdoom() {
    gitPullOrClone "$md_build" https://github.com/EmulOS/zdoom.git retropie
}
