...
if [ ! -d "/home/pi/MasOS/roms/mame-advmame" ]; then
        echo "Advance-Mame not found. Installing version 1.4. This will take around 30min."
        sleep 10
        sudo /home/pi/MasOS-Setup/masos_pkgs.sh 101
fi
...
echo ""
echo ""
echo "Downloading gun configureation application. This will appear in your MasOS menu after install. You will need to calibrate the gun prior to gameplay."
sleep 8
cd
...
cd /home/pi/MasOS/roms/mame-advmame/
if [ ! -f "/home/pi/MasOS/roms/mame-advmame/alien3.zip" ]; then
        wget http://eazyhax.com/pitime/shooter/alien3.zip
fi
if [[ ! -f "/home/pi/MasOS/roms/mame-advmame/le2.zip" ]]; then
        wget http://eazyhax.com/pitime/shooter/le2.zip
fi
if [[ ! -f "/home/pi/MasOS/roms/mame-advmame/duckhunt.zip" ]]; then
