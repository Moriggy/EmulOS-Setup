...
function _add_system_attractmode() {
    ...
    if [[ "$name" == "emulos" ]]; then
      ...
      cat >> /home/$user/EmulOS/roms/emulos/EmulationStation.sh << EOF
      clear
      ...
      sudo reboot
      EOF
      cat >> /home/$user/EmulOS/emulosmenu/Attract-Mode.sh << EOF
      ...
      cat >> /home/$user/.attract/emulators/EmulOS.cfg << EOF
