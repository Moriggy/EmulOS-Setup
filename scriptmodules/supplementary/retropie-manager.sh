...
rp_module_licence="MIT https://raw.githubusercontent.com/EmulOS/EmulOS-Manager/emulos/ORIGINAL%20LICENCE.txt"
rp_module_repo="git https://github.com/Moriggy/EmulOS-Manager.git emulos"
